...
using EmbyKinopoiskTrailers.ScheduledTasks;
using EmbyKinopoiskTrailers.Tests.Utils;
...
public class UpdateKinopoiskPluginTaskTest : BaseTest
{
    ...
    public async Task UpdateKinopoiskPluginTask_Execute_NoChanges()
    {
        ...
        response.Content = new MemoryStream(Encoding.UTF8.GetBytes( /*lang=json,strict*/ $"{{\"html_url\":\"https://\",\"tag_name\":\"{currentVersion}\",\"assets\":[{{\"name\":\"EmbyKinopoiskTrailers.dll\",\"content_type\":\"program\",\"browser_download_url\":\"https://\"}}],\"body\":\"description\"}}"));
    ...
    public async Task UpdateKinopoiskPluginTask_Execute_Updated_OldTag()
    {
        ...
        using HttpResponseInfo response = new();
        response.Content = new MemoryStream(Encoding.UTF8.GetBytes( /*lang=json,strict*/ "{\"html_url\":\"https://\",\"tag_name\":\"1.0.0\",\"assets\":[{\"name\":\"EmbyKinopoiskTrailers.dll\",\"content_type\":\"program\",\"browser_download_url\":\"https://\"}],\"body\":\"description\"}"));
        response.StatusCode = HttpStatusCode.OK;
        _httpClient.ReturnResponse = response;
    ...
    public async Task UpdateKinopoiskPluginTask_Execute_Updated_NewTag()
    {
        ...
        using HttpResponseInfo response = new();
        response.Content = new MemoryStream(Encoding.UTF8.GetBytes( /*lang=json,strict*/ "{\"html_url\":\"https://\",\"tag_name\":\"v.1.0.0\",\"assets\":[{\"name\":\"EmbyKinopoiskTrailers.dll\",\"content_type\":\"program\",\"browser_download_url\":\"https://\"}],\"body\":\"description\"}"));
        response.StatusCode = HttpStatusCode.OK;
        _httpClient.ReturnResponse = response;
