define(['loading', 'globalize', 'emby-input', 'emby-button', 'emby-radio', 'emby-checkbox', 'emby-linkbutton', 'emby-select'], function (loading) {
  ...
  function onSubmit(e) {
    ...
    getConfig().then(function (config) {
      ...
      ApiClient.updatePluginConfiguration('0238d371-d7af-4459-be2c-93268fc0cc89', config).then(Dashboard.processServerConfigurationUpdateResult);
    });
    return false;
  }
  ...
  function getConfig() {
    return ApiClient.getPluginConfiguration('0238d371-d7af-4459-be2c-93268fc0cc89');
  }
