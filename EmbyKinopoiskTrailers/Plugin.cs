...
using EmbyKinopoiskTrailers.Api;
using EmbyKinopoiskTrailers.Api.KinopoiskApiUnofficial;
using EmbyKinopoiskTrailers.Api.KinopoiskDev;
using EmbyKinopoiskTrailers.Configuration;
...
namespace EmbyKinopoiskTrailers
{
    /// <summary>
    /// The main plugin.
    /// </summary>
    ...
    {
        internal const string PluginKey = "KinopoiskTrailers";
        internal const string PluginName = "Кинопоиск.Трейлеры";
        internal const string PluginGuid = "0238d371-d7af-4459-be2c-93268fc0cc89";
