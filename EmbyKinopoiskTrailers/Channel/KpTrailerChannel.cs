...
using EmbyKinopoiskTrailers.TrailerDownloader.Youtube;
using EmbyKinopoiskTrailers.TrailerDownloader;
using EmbyKinopoiskTrailers.TrailerDownloader.Kinopoisk;
...
namespace EmbyKinopoiskTrailers.Channel
{
    /// <summary>
