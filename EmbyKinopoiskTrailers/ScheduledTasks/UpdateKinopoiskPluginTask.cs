...
using EmbyKinopoiskTrailers.ScheduledTasks.Model;
...
namespace EmbyKinopoiskTrailers.ScheduledTasks
{
    /// <summary>
    ...
    public class UpdateKinopoiskPluginTask : BaseTask, IScheduledTask, IConfigurableScheduledTask
    {
        ...
        private const string DllName = "EmbyKinopoiskTrailers.dll";
        private const string TaskKey = "KinopoiskTrailersNewVersion";
        ...
        private async Task<GitHubLatestReleaseResponse> GetGitHubLatestReleaseAsync(CancellationToken cancellationToken)
        {
            var options = new HttpRequestOptions
            {
                ...
                Url = "https://api.github.com/repos/luzmane/emby.kinopoisk.trailers/releases/latest",
                LogResponse = true,
